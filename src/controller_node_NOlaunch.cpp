...
#define  min_dist 4  			//Min. spline points distance.
#define  rc_max 120 			//Max. curvature radius. 
#define  rc_min 1  			//Min. curvature radius.
#define  v_max 13.5
#define  PI 3.1416
#define  N_RET_VEL 4			//Number of delays for delay compensation. (Np + Nc)
#define  q11 7.5
#define  q22 0.0001
#define  r11 100
#define  Ts 10
...
double x_fin, y_fin;
double coefs[n_max][8], sample_time = 0.1;
...
//Controller parametres (RODRIGO)
double A[4]={1,v*sample_time,0,1},B[2]={v*(sample_time)+(v*v*sample_time*sample_time)/(2*dist_wheels),v*(sample_time)/2},Q[4]={q11,0,0,q22}, R=r11, Kr[2]; //Q[4]={300,0,0,0.0001}, R=50000 TESLA 
//Delay compensation variables
double buffer_vel[2][N_RET_VEL];
double evol_vel[2][N_RET_VEL]; //fila 1 v, fila 2 ro //RODRIGO
